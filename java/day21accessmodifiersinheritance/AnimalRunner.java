...
public class AnimalRunner {
    ...
    /*
        ...
        2)Bir Class'i baska bir Class'in Child Class'i yapmak icin
          "extends" keyword kulanilir. ilk yazilan Class Child, ikinci
           yazilan Class parent olur.

        3)Child Class object'leri Parent Class'dan method ve variable'lari kulanabilirler.
        ...
        6) "private" method ve variable'lar Child Class'lar tarafindan kullanilamaz
           ...
           "default" method ve variable'lar ayni package'deki Child Class'lar tarafindan kullanilabilir.
            ...
            Note: "Child Class'lar tarafindan kullanilabilir" olmak demek "inherit edilebilir" demektir.
        ...
        7)4 tip inheritance vardir
           ...
           iii) Multiple Inheritance : Bir Child'a coklu Parent, Java bunu desteklemez.(Java does not support Multiple Inharitance)
