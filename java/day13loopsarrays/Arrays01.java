...
public class Arrays01 {
    ...
    1) Ayni data tipinde, coklu data'i depolamak icin Java'nin olusturdugu yapilar vardir
        Bu yapilrdan birisi de "Array" lerdir.
     */
    public static void main(String[] args) {

        //Array nasil olusturulur?
        int stdAges[] = new int[7];  //[0, 0, 0, 0, 0, 0, 0]            **** 12, 11, 13, 14, 10, 12, 12***
        ...
        //"length()" String'lerde kullanilir, "length"  Array'lerde kullanilir.(parantezli /parantezsiz kullanimi)
        ...
        //           Bu Array ' e 5 tane eleman ekleyiniz
