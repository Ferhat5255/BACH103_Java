...
public class ArrayLists01 {
    ...
    /*
    ArrayLists'ler ayni data tipine sahip birden faza data'yi depolamak icin kullanilir.
    ...
    1) Array olustururken Array'in icine kac tane eleman koymamiz gerektigini soylemeliyiz,
      soyledigimiz eleman sayisindan fazla eleman koyamayiz.
       ...
       ArrayLists'leri olustururken eleman sayisi soylemeye gerek yok ,
       cunku ArrayLists'ler eleman sayisinda "flexible"(esnek) dirlar.

     2) Array ' lerin icine "primitive" ve "reference" lar konabilir.
        ArrayLists'lerin icine ise sadece "non-primitive" ler konulur.
    ...
    public static void main(String[] args) {
        ...
        nums.add(21);                             //add methodu boolean ekler yani true(gorev tamam demek) veya false(yerlestirelemedi)
        nums.add(18);
        nums.add(20);
       ...
       boolean bos1 = nums.isEmpty();
        ...
        //remove() method'unun icine tamsayi koyarsaniz Java onu index olarak kabul eder
                //nums.remove(200);          nums.remove(new Integer (200));

        //ArrayList'den 34 elemaninin ilk gorunumunu siliniz
