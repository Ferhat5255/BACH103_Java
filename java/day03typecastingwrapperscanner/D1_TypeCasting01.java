...
public class D1_TypeCasting01 {

    //Type Casting: Bir numerik data type'ini diger data type'ina cevirmek demektir.
    ...
    public static void main(String[] args) {
        ...
        //Ezample 1 : short 'u double 'a ceviren kodu yazınız
        ...
        System.out.println(newprice);  //12  ==>  Java ondalik sayiyi , tam sayiya cevirirken yuvarlam islemi yapmaz.
